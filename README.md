...
<ul>
<li>Система <b>Интернет-магазин</b>.</li>
<li><b>Администратор</b>  осуществляет ведение каталога <b>Товаров</b>.</li>
<li><b>Клиент</b> делает и оплачивает <b>Заказ</b> на <b>Товары</b>.</li>
<li><b>Администратор</b> может занести неплательщиков в “черный список”.</li>
</ul>
