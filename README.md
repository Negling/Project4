...
12.	Код должен содержать комментарии.
	...
	Система <b>Интернет-магазин</b>. <b>Администратор</b>  осуществляет ведение каталога <b>Товаров</b>. <b>Клиент</b> делает и оплачивает <b>Заказ</b> на <b>Товары</b>.          <b>Администратор</b> может занести неплательщиков в “черный список”.
